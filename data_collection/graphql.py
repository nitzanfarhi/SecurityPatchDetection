...
less_than_10_vulns = ['01org_opa-ff', '01org_opa-fm', '01org_tpm2.0-tools', '10gen-archive_mongo-c-driver-legacy', '1up-lab_oneupuploaderbundle', '389ds_389-ds-base', '3s3s_opentrade', '94fzb_zrlog', 'aaron-junker_usoc', 'aaugustin_websockets', 'aawc_unrar', 'abcprintf_upload-image-with-ajax', 'abhinavsingh_proxy.py', 'absolunet_kafe', 'acassen_keepalived', 'accel-ppp_accel-ppp', 'accenture_mercury', 'acinq_eclair', 'acossette_pillow', 'acpica_acpica', 'actions_http-client', 'adaltas_node-csv-parse', 'adaltas_node-mixme', 'adamghill_django-unicorn', 'adamhathcock_sharpcompress', 'adaptivecomputing_torque', 'admidio_admidio', 'adodb_adodb', 'adrienverge_openfortivpn', 'advancedforms_advanced-forms', 'afarkas_lazysizes', 'ahdinosaur_set-in', 'aheckmann_mpath', 'aheckmann_mquery', 'aimhubio_aim', 'aio-libs_aiohttp', 'aircrack-ng_aircrack-ng', 'airmail_airmailplugin-framework', 'airsonic_airsonic', 'ai_nanoid', 'akashrajpurohit_clipper', 'akheron_jansson', 'akimd_bison', 'akrennmair_newsbeuter', 'alanaktion_phproject', 'alandekok_freeradius-server', 'alanxz_rabbitmq-c', 'albertobeta_podcastgenerator', 'alerta_alerta', 'alexreisner_geocoder', 'alex_rply', 'algolia_algoliasearch-helper-js', 'alkacon_apollo-template', 'alkacon_mercury-template', 'alkacon_opencms-core', 'amazeeio_lagoon', 'ambiot_amb1_arduino', 'ambiot_amb1_sdk', 'ampache_ampache', 'amyers634_muracms', 'anchore_anchore-engine', 'andialbrecht_sqlparse', 'andrerenaud_pdfgen', 'android_platform_bionic', 'andrzuk_finecms', 'andya_cgi--simple', 'andyrixon_layerbb', 'angus-c_just', 'ankane_chartkick', 'ansible-collections_community.crypto', 'ansible_ansible-modules-extras', 'antonkueltz_fastecdsa', 'antswordproject_antsword', 'anurodhp_monal', 'anymail_django-anymail', 'aomediacodec_libavif', 'apache_activemq-artemis', 'apache_activemq', 'apache_cordova-plugin-file-transfer', 'apache_cordova-plugin-inappbrowser', 'apache_cxf-fediz', 'apache_cxf', 'apache_incubator-livy', 'apache_incubator-openwhisk-runtime-docker', 'apache_incubator-openwhisk-runtime-php', 'apache_ofbiz-framework', 'apache_openoffice', 'apache_vcl', 'apexcharts_apexcharts.js', 'apollosproject_apollos-apps', 'apostrophecms_apostrophe', 'apple_cups', 'appneta_tcpreplay', 'aptana_jaxer', 'aquaverde_aquarius-core', 'aquynh_capstone', 'arangodb_arangodb', 'archivy_archivy', 'ardatan_graphql-tools', 'ardour_ardour', 'area17_twill', 'aresch_rencode', 'argoproj_argo-cd', 'arjunmat_slack-chat', 'arrow-kt_arrow', 'arsenal21_all-in-one-wordpress-security', 'arsenal21_simple-download-monitor', 'arslancb_clipbucket', 'artifexsoftware_ghostpdl', 'artifexsoftware_jbig2dec', 'asaianudeep_deep-override', 'ashinn_irregex', 'askbot_askbot-devel', 'assfugil_nickchanbot', 'asteinhauser_fat_free_crm', 'atheme_atheme', 'atheme_charybdis', 'atinux_schema-inspector', 'att_ast', 'auracms_auracms', 'aurelia_path', 'auth0_ad-ldap-connector', 'auth0_auth0.js',
                      'auth0_express-jwt', 'auth0_express-openid-connect', 'auth0_lock', 'auth0_nextjs-auth0', 'auth0_node-auth0', 'auth0_node-jsonwebtoken', 'auth0_omniauth-auth0', 'authelia_authelia', 'authguard_authguard', 'authzed_spicedb', 'automattic_genericons', 'automattic_mongoose', 'autotrace_autotrace', 'autovance_ftp-srv', 'avar_plack', 'avast_retdec', 'awslabs_aws-js-s3-explorer', 'awslabs_tough', 'aws_aws-sdk-js-v3', 'aws_aws-sdk-js', 'axdoomer_doom-vanille', 'axios_axios', 'axkibe_lsyncd', 'b-heilman_bmoor', 'babelouest_glewlwyd', 'babelouest_ulfius', 'bacula-web_bacula-web', 'badongdyc_fangfacms', 'bagder_curl', 'balderdashy_sails-hook-sockets', 'ballerina-platform_ballerina-lang', 'bbangert_beaker', 'bbengfort_confire', 'bblanchon_arduinojson', 'bblfsh_bblfshd', 'bcfg2_bcfg2', 'bcit-ci_codeigniter', 'bcosca_fatfree-core', 'bdew-minecraft_bdlib', 'beanshell_beanshell', 'behdad_harfbuzz', 'belledonnecommunications_belle-sip', 'belledonnecommunications_bzrtp', 'benjaminkott_bootstrap_package', 'bertramdev_asset-pipeline', 'bettererrors_better_errors', 'billz_raspap-webgui', 'bit-team_backintime', 'bitcoin_bitcoin', 'bitlbee_bitlbee', 'bitmessage_pybitmessage', 'bittorrent_bootstrap-dht', 'blackcatdevelopment_blackcatcms', 'blackducksoftware_hub-rest-api-python', 'blogifierdotnet_blogifier', 'blogotext_blogotext', 'blosc_c-blosc2', 'bludit_bludit', 'blueness_sthttpd', 'bluez_bluez', 'bminor_bash', 'bminor_glibc', 'bonzini_qemu', 'boonebgorges_buddypress-docs', 'boonstra_slideshow', 'boothj5_profanity', 'bottlepy_bottle', 'bouke_django-two-factor-auth', 'bower_bower', 'boxug_trape', 'bradyvercher_gistpress', 'braekling_wp-matomo', 'bratsche_pango', 'brave_brave-core', 'brave_muon', 'briancappello_flask-unchained', 'brocaar_chirpstack-network-server', 'broofa_node-uuid', 'brookinsconsulting_bccie', 'browserless_chrome', 'browserslist_browserslist', 'browserup_browserup-proxy', 'bro_bro', 'btcpayserver_btcpayserver', 'buddypress_buddypress', 'bytecodealliance_lucet', 'bytom_bytom', 'c-ares_c-ares', 'c2fo_fast-csv', 'cakephp_cakephp', 'canarymail_mailcore2', 'candlepin_candlepin', 'candlepin_subscription-manager', 'canonicalltd_subiquity', 'caolan_forms', 'capnproto_capnproto', 'carltongibson_django-filter', 'carrierwaveuploader_carrierwave', 'catfan_medoo', 'cauldrondevelopmentllc_cbang', 'ccxvii_mujs', 'cdcgov_microbetrace', 'cdrummond_cantata', 'cdr_code-server', 'ceph_ceph-deploy', 'ceph_ceph-iscsi-cli', 'certtools_intelmq-manager', 'cesanta_mongoose-os', 'cesanta_mongoose', 'cesnet_perun', 'chalk_ansi-regex', 'charleskorn_kaml', 'charybdis-ircd_charybdis', 'chaskiq_chaskiq', 'chatsecure_chatsecure-ios', 'chatwoot_chatwoot', 'check-spelling_check-spelling', 'cherokee_webserver', 'chevereto_chevereto-free', 'chillu_silverstripe-framework', 'chjj_marked', 'chocolatey_boxstarter', 'chopmo_rack-ssl', 'chrisd1100_uncurl', 'chyrp_chyrp',
                      'circl_ail-framework', 'cisco-talos_clamav-devel', 'cisco_thor', 'civetweb_civetweb', 'ckeditor_ckeditor4', 'ckolivas_cgminer', 'claviska_simple-php-captcha', 'clientio_joint', 'cloudendpoints_esp', 'cloudfoundry_php-buildpack', 'clusterlabs_pacemaker', 'cmuir_uncurl', 'cnlh_nps', 'cobbler_cobbler', 'cockpit-project_cockpit', 'codecov_codecov-node', 'codehaus-plexus_plexus-archiver', 'codehaus-plexus_plexus-utils', 'codeigniter4_codeigniter4', 'codemirror_codemirror', 'codiad_codiad', 'cog-creators_red-dashboard', 'cog-creators_red-discordbot', 'collectd_collectd', 'commenthol_serialize-to-js', 'common-workflow-language_cwlviewer', 'composer_composer', 'composer_windows-setup', 'concrete5_concrete5-legacy', 'containers_bubblewrap', 'containers_image', 'containers_libpod', 'containous_traefik', 'contiki-ng_contiki-ng', 'convos-chat_convos', 'cooltey_c.p.sub', 'coreutils_gnulib', 'corosync_corosync', 'cosenary_instagram-php-api', 'cosmos_cosmos-sdk', 'cotonti_cotonti', 'coturn_coturn', 'crater-invoice_crater', 'crawl_crawl', 'creatiwity_witycms', 'creharmony_node-etsy-client', 'crowbar_barclamp-crowbar', 'crowbar_barclamp-deployer', 'crowbar_barclamp-trove', 'crowbar_crowbar-openstack', 'crypto-org-chain_cronos', 'cthackers_adm-zip', 'ctripcorp_apollo', 'ctz_rustls', 'cubecart_v6', 'cure53_dompurify', 'cvandeplas_pystemon', 'cve-search_cve-search', 'cveproject_cvelist', 'cyberark_conjur-oss-helm-chart', 'cyberhobo_wordpress-geo-mashup', 'cydrobolt_polr', 'cyrusimap_cyrus-imapd', 'cyu_rack-cors', 'd0c-s4vage_lookatme', 'd4software_querytree', 'daaku_nodejs-tmpl', 'dagolden_capture-tiny', 'dajobe_raptor', 'daltoniam_starscream', 'dandavison_delta', 'dankogai_p5-encode', 'danschultzer_pow', 'darktable-org_rawspeed', 'darold_squidclamav', 'dart-lang_sdk', 'darylldoyle_svg-sanitizer', 'dashbuilder_dashbuilder', 'datacharmer_dbdeployer', 'datatables_datatablessrc', 'datatables_dist-datatables', 'dav-git_dav-cogs', 'davegamble_cjson', 'davidben_nspluginwrapper', 'davideicardi_confinit', 'davidjclark_phpvms-popupnews', 'daylightstudio_fuel-cms', 'dbeaver_dbeaver', 'dbijaya_onlinevotingsystem', 'dcit_perl-crypt-jwt', 'debiki_talkyard', 'deislabs_oras', 'delta_pragyan', 'delvedor_find-my-way', 'demon1a_discord-recon', 'denkgroot_spina', 'deoxxa_dotty', 'dependabot_dependabot-core', 'derf_feh', 'derickr_timelib', 'derrekr_android_security', 'desrt_systemd-shim', 'deuxhuithuit_symphony-2', 'devsnd_cherrymusic', 'dexidp_dex', 'dgl_cgiirc', 'dhis2_dhis2-core', 'diegohaz_bodymen', 'diegohaz_querymen', 'dieterbe_uzbl', 'digint_btrbk', 'digitalbazaar_forge', 'dingelish_rust-base64', 'dinhviethoa_libetpan', 'dino_dino', 'directus_app', 'directus_directus', 'discourse_discourse-footnote', 'discourse_discourse-reactions', 'discourse_message_bus', 'discourse_rails_multisite', 'diversen_gallery', 'divio_django-cms', 'diygod_rsshub', 'djabberd_djabberd', 'django-helpdesk_django-helpdesk', 'django-wiki_django-wiki', 'dlitz_pycrypto', 'dmendel_bindata', 'dmgerman_ninka', 'dmlc_ps-lite', 'dmproadmap_roadmap', 'dnnsoftware_dnn.platform', 'docker_cli', 'docker_docker-credential-helpers', 'docsifyjs_docsify', 'doctrine_dbal', 'documize_community', 'dogtagpki_pki', 'dojo_dijit', 'dojo_dojo', 'dojo_dojox', 'dollarshaveclub_shave', 'dom4j_dom4j', 'domoticz_domoticz', 'dompdf_dompdf', 'doorgets_doorgets', 'doorkeeper-gem_doorkeeper', 'dosfstools_dosfstools', 'dotcms_core', 'dotse_zonemaster-gui', 'dottgonzo_node-promise-probe', 'dovecot_core', 'doxygen_doxygen', 'dozermapper_dozer', 'dpgaspar_flask-appbuilder', 'dracutdevs_dracut', 'dramforever_vscode-ghc-simple', 'drk1wi_portspoof', 'droolsjbpm_drools', 'droolsjbpm_jbpm-designer', 'droolsjbpm_jbpm', 'droolsjbpm_kie-wb-distributions', 'dropbox_lepton', 'dropwizard_dropwizard', 'drudru_ansi_up', 'dspace_dspace', 'dspinhirne_netaddr-rb', 'dsyman2_integriaims', 'dtschump_cimg', 'duchenerc_artificial-intelligence', 'duffelhq_paginator', 'dukereborn_cmum', 'duncaen_opendoas', 'dutchcoders_transfer.sh', 'dvirtz_libdwarf', 'dweomer_containerd', 'dwisiswant0_apkleaks', 'dw_mitogen', 'dynamoose_dynamoose', 'e107inc_e107', 'e2guardian_e2guardian', 'e2openplugins_e2openplugin-openwebif', 'eclipse-ee4j_mojarra', 'eclipse_mosquitto', 'eclipse_rdf4j', 'eclipse_vert.x', 'edge-js_edge', 'edgexfoundry_app-functions-sdk-go', 'edx_edx-platform', 'eflexsystems_node-samba-client', 'eggjs_extend2', 'egroupware_egroupware', 'eiskalteschatten_compile-sass', 'eivindfjeldstad_dot', 'elabftw_elabftw', 'elastic_elasticsearch', 'eldy_awstats', 'elementary_switchboard-plug-bluetooth', 'elementsproject_lightning', 'elixir-plug_plug', 'ellson_graphviz', 'elmar_ldap-git-backup', 'elric1_knc', 'elves_elvish', 'embedthis_appweb', 'embedthis_goahead', 'emca-it_energy-log-server-6.x', 'emlog_emlog', 'enalean_gitphp', 'enferex_pdfresurrect', 'ensc_irssi-proxy', 'ensdomains_ens', 'enviragallery_envira-gallery-lite', 'envoyproxy_envoy', 'ericcornelissen_git-tag-annotation-action', 'ericcornelissen_shescape', 'ericnorris_striptags', 'ericpaulbishop_gargoyle', 'erikdubbelboer_phpredisadmin', 'erlang_otp', 'erlyaws_yaws', 'esl_mongooseim', 'esnet_iperf', 'esphome_esphome', 'ethereum_go-ethereum', 'ethereum_solidity', 'ether_ueberdb', 'ettercap_ettercap', 'eugeneware_changeset', 'eugeny_ajenti', 'evangelion1204_multi-ini', 'evanphx_json-patch', 'evilnet_nefarious2', 'evilpacket_marked',
                      'excon_excon', 'exiftool_exiftool', 'exim_exim', 'express-handlebars_express-handlebars', 'eyesofnetworkcommunity_eonweb', 'ezsystems_ezjscore', 'f21_jwt', 'fabiocaccamo_utils.js', 'fabpot_twig', 'facebookincubator_fizz', 'facebookincubator_mvfst', 'facebookresearch_parlai', 'facebook_buck', 'facebook_folly', 'facebook_mcrouter', 'facebook_nuclide', 'facebook_react-native', 'facebook_wangle', 'facebook_zstd', 'faisalman_ua-parser-js', 'faiyazalam_wordpress-plugin-user-login-history', 'fardog_trailing-slash', 'fasterxml_jackson-dat']
...
attrib_list = ["vulnerabilityAlerts", "forks", "issues", "pullRequests", "releases", "stargazers", "commits"]
...
def get_commit_metadata(owner,repo):
  ...
  res['languages_edges']=list(map(lambda lang: lang['node']['name'],res['languages_edges']))

  return res

def get_all_commits(owner, repo):
    branch_lst = run_query(branches_ql.format(owner, repo))
    branch_lst = [res['name'] for res in branch_lst['data']['repository']['refs']['nodes']]
    ...
    for branch in branch_lst:
        print(f"\t\t{branch}")
        cur_commit_date, cur_additions, cur_deletions, cur_oids = get_commits(owner, repo, branch)
...
def get_commits(owner, repo, branch):
    ...
    if "data" in result and result["data"]["repository"]["object"] is not None:
        ...
        for _ in range(0, total_count, 100):
            endCursor = result['data']['repository']['object']['history']['pageInfo']['endCursor']
            ...
            result = run_query(commits_ql.format(repo, owner, branch, 'after:"{0}"'.format(endCursor)))
    ...
    if "data" in result:
        ...
        for _ in range(0, total_count, 100):
            ...
            for val in result['data']['repository']['stargazers']['edges']:
                staredAt.append(val['starredAt'])

            result = run_query(stargazer_query.format(repo, owner, 'after:"{0}"'.format(endCursor)))
            if "data" not in result:
                print("Error5", result)
                break
    else:
    ...
    if 'data' in result:
        ...
        for _ in range(0, total_count, 100):
            ...
            for val in result['data']['repository'][attribute]['edges']:
                dates.append(val['node']['createdAt'])

            result = run_query(generalQL.format(repo, owner, attribute, 'after:"{0}"'.format(endCursor)))
            if 'data' not in result:
                break
...
def get_repo(repo, idx):
    ...
    fields = ["username", "name", "email", "twitter_username", "repo_count", "blog", "company", "bio", "avatar_url",
              "hireable", "num_followers", "num_following", "created_at", "updated_at", "star_time"]
    ...
    for attribute in attrib_list:
        ...
        if attribute == "stargazers":
            ...
            res_dict['additions'], res_dict['deletions'], res_dict['commit_date'],res_dict['oid'] = get_all_commits(owner, repo)
        else:
            res_dict[attribute] = get_attribute(owner, repo, attribute)

    with open(f"{OUTPUT_DIRNAME}/{owner}_{repo}.csv", "w",newline='') as outfile:
